...
def main():
    global DEBUG, VERBOSE, KISMET_HOST, KISMET_USER, KISMET_PASS, KISMET_PORT, KISMET_SSL, KISMET_HTTP_PROTOCOL, MAC_ADDR, DB_HOST, DB_USER, DB_PASS, DB_NAME, CHECK_INTERVAL
